 ...
 * Forwards the grab (immediately, just that die) via `onGrabbed`, each flick's
 * settled values via `onReroll`, and grab-to-add dice via `onAdded` for logging.
